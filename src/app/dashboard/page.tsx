...
const statCards = [
  { label: "全年度平均", value: 61.2, change: "-2.6%", negative: true },
  { label: "上位10%平均", value: 87.3, change: "-1.4%", negative: true },
  { label: "中位層平均", value: 55.6, change: "-4.2%", negative: true },
  { label: "下位10%平均", value: 31.5, change: "-2.7%", negative: true },
];
            ...
            <div className="stat-card">
              ...
              <div className="flex items-end gap-2">
                <span className="text-2xl font-bold text-[var(--foreground)]">
                  <CountUp end={stat.value} decimals={1} suffix="点" duration={1000 + i * 200} />
                </span>
          ...
          <div className="card">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={yearlyComparison}>
                ...
                />
                <Legend />
                <Line type="monotone" dataKey="平均点" stroke="#2563eb" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} animationDuration={1500} />
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--border)]">
                    ...
                    <th className="text-right py-3 px-3 font-semibold text-[var(--muted)]">平均点</th>
                ...
                <tbody>
                  {classComparison.map((row) => (
                    <tr key={row.class} className="border-b border-[var(--border)] last:border-b-0">
                      ...
                      <td className="py-3 px-3 text-right font-semibold">{row.平均点}点</td>
