...
export const studentsList: StudentDetail[] = [
  ...
  },
  {
    ...
    strengths: ["数学の伸びが著しい（+8pt/3ヶ月）", "文章題への取り組み意欲が高い"],
    weaknesses: ["英語のリスニング分野が弱い", "ケアレスミスが多い（特に計算）"],
    aiComment: "山田くんは直近3ヶ月で数学の偏差値が8ポイント上昇しており、成長速度は学年トップクラスです。一方、英語のリスニングと計算ミスが課題です。計算ミスは「検算の習慣化」で改善可能であり、これだけで偏差値1〜2ポイントの改善が見込めます。早稲田商学部合格には英語の底上げが鍵です。",
  },
  {
  ...
  },
  {
    ...
    aiComment: "田中さんは着実に成績を伸ばしており、5ヶ月前の偏差値55から59.4まで上昇しました。日本史は偏差値65と強みです。数学の応用問題と化学分野が課題ですが、学習習慣が非常に安定しているため、適切な教材を与えれば確実に伸びるタイプです。関西学院大学の合格ラインまであと2.6ポイントです。",
  },
  {
  ...
  },
  {
    ...
    strengths: ["この2ヶ月で偏差値が4ポイント上昇", "数学の基礎計算力が改善", "前向きな学習態度"],
    weaknesses: ["全科目で基礎の抜けが多い", "テスト慣れしていない", "時間配分に課題"],
    aiComment: "小林くんはこの2ヶ月で偏差値が46.5から50.5へと大きく伸びました。基礎計算ドリルの効果が出ています。まだ全科目で基礎の抜けがありますが、改善傾向は明確です。同志社大学の合格ライン55まであと4.5ポイント。このペースを維持すれば12月末には到達可能です。模試形式の練習を増やすことを推奨します。",
  },
];
