...
export const studentsList: StudentDetail[] = [
  ...
  {
    id: "s009", name: "田中 太郎", class: "Aクラス", grade: "高2",
    latestScore: 310, trend: "up", targetSchool: "早稲田大学 商学部", deviation: 65.0,
    avatarInitial: "田", tags: ["英語◎", "12日連続学習", "物理課題"],
    targetDepartment: "商学部", entranceMethod: "一般入試", targetDeviation: 68.0,
    strengths: ["英語は偏差値72.8と全科目中最高", "12日連続学習と学習習慣が安定", "AI学習アシスタントを活用して自走学習ができる"],
    weaknesses: ["物理の偏差値58.6が足を引っ張っている", "数学IIBの理解度が62%と低い", "タスク完了率が週によってばらつきがある"],
    aiComment: "田中くんは英語が偏差値72.8と大きな武器で、12日連続学習と学習習慣も安定しています。一方、物理（偏差値58.6）と数学IIB（理解度62%）が課題です。早稲田商学部は英語重視の配点なので、英語を維持しつつ数学の底上げができれば合格圏内です。タスク完了率が第4週に68%まで落ちた原因を確認し、安定して85%以上を維持できるようにしましょう。",
  },
];
